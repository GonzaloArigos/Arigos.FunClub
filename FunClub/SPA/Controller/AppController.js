...
app.config(function ($translateProvider) {
    ...
    $translateProvider.translations('es', {
        ...
        DASHBOARD: "Estado de situación",
        MASIVE_LOAD: "Carga masiva entradas",
        MIS_DISCO: "Mis discotecas",
        PRODUCT_MANAGER: "Gestión produtos",
        TICKET_MANAGER: "Gestión entradas",
        TICKET_SELL: "Venta de entradas",
