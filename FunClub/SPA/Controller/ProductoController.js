angular.module('app').controller("ProductoController", ["$scope", "ProductoService", "ngDialog", 'Excel', '$timeout', 'Upload', "$q", function ($scope, ProductoService, ngDialog, Excel, $timeout, Upload, $q) {
