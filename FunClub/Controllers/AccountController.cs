        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Tu registro en FunClub concluyó correctamente!", "Para confirmar su cuenta hacer click en el siguiente link: <a href=\"" + callbackUrl + "\">here</a>");
